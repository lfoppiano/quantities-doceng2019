...
Table \ref{tab:quantities-model-labels} describes the labels predicted by the \textit{Quantities} CRF model. Notice that, to reconstruct complex structured objects from the flat sequence generated by engine, additional labels are necessary (such as <unitLeft>, <unitRight>, for units).
